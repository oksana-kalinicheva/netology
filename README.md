...
#  Дипломная работа по профессии «Системный администратор» - Калиничева Оксана
...
Настроена ВМ с Bastion host, с публичным ip-адресом и открытым ssh-портом, подключение ansible осуществляется через эту ВМ, сам Ansible располагается на домашней машине с Kali Linux.
